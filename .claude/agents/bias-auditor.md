...
1. `CLAUDE.md` -- 6-axis bias model (full specs), 7-point lean spectrum, LOW_CREDIBILITY_US_MAJOR, 1,013 sources
...
5. `pipeline/validation/fixtures.py` -- 42 ground-truth articles across 9 categories
