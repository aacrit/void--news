...
| **History** | Live, 78 events, static JSON since rev 69. Landing prerendered with an `<h1>` and every card (2026-09-21); era, region and thread browse routes linked and in the sitemap; native scroll, no wheel hijack. 149 time-bound claims dated or dropped 2026-09-21 (`docs/audits/HISTORY-DATA-2026-09-21.md`). **Thesis pilot** (2026-09-24): `/history/srebrenica-genocide/` is the **first published thesis** (independent Stage 5 audit, two passes, stamped in the front matter); the other 77 events render the Hearing. Partition and Mongol Baghdad not started. |
