...
| **History** | Live, 78 events, static JSON since rev 69. Landing prerendered with an `<h1>` and every card (2026-09-21); era, region and thread browse routes linked and in the sitemap; native scroll, no wheel hijack. 149 time-bound claims dated or dropped 2026-09-21 (`docs/audits/HISTORY-DATA-2026-09-21.md`). **Five published theses** (Srebrenica 2026-09-24; Partition, Cambodian genocide, Scramble for Africa, 1918 influenza 2026-09-25), each after an independent Stage 5 audit in two passes, stamped in the front matter; Armenian genocide and Haitian Revolution are at draft between their audit passes; the other 71 events render the Hearing. |
