...
- Gemini 2.5 Flash free tier for cluster summarization (1500 RPD limit, pipeline uses ~30 RPD).
...
```
 ...
 7b. SUMMARIZE    — Gemini Flash: headlines, summaries, consensus/divergence for 3+-source clusters (15-call cap)
...
Summarization:   Gemini 2.5 Flash free tier (15 calls/run, 30 RPD) — $0
