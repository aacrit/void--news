...
Last updated: 2026-04-29 (rev 39 — $100B layout overhaul + Lighthouse polish + CF Pages migration in flight)
...
├── frontend/
│   ├── app/
│   │   ├── components/    # 53 components (HomeContent: EDITION_FEED_SIZE=50, CATEGORY_CAP=12, fetch=80; StoryCard variant=digest|wire; BiasSnapshot inline+rail)
...
│   ├── public/            # _headers (Cloudflare Pages cache + security policy; ignored by GH Pages)
