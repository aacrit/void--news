...
| **History** | Live, 78 events, static JSON since rev 69. Landing prerendered with an `<h1>` and every card (2026-09-21); era, region and thread browse routes linked and in the sitemap; native scroll, no wheel hijack. 149 time-bound claims dated or dropped 2026-09-21 (`docs/audits/HISTORY-DATA-2026-09-21.md`). **Three published theses**: `/history/srebrenica-genocide/` (2026-09-24), `/history/partition-of-india/` (2026-09-25) and `/history/cambodian-genocide/` (2026-09-25), each after an independent Stage 5 audit in two passes, stamped in the front matter; the other 75 events render the Hearing. Mongol Baghdad not started. |
