...
| E-15 | A hedge is not an attribution: "reportedly", "allegedly" and "is said to" carrying a reputational claim | ADVISORY | E-05 used to accept "reportedly" as naming a source. It names no one. A sentence that says something reputational about a person with only a hedge behind it is flagged so the card either names who reports it or loses the sentence. Advisory first (2026-09-21); hard once a run has shown how often it fires. |
