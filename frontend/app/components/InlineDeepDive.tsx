  ...
  return (
    <article ref={articleRef} className="inline-dd" aria-label={`Deep dive: ${story.title}`}>
      ...
      <div className="inline-dd__content">
        {/* No full-panel skeleton: the summary + Sigil are already carried on the
            story and render immediately below. The only genuinely-pending data is
            the full source spread, flagged with the subtle inline line further
