...
export async function fetchWeeklyDigest(edition: string): Promise<any | null> {
  ...
  const cols = 'id, edition, week_start, week_end, issue_number, cover_headline, cover_text, cover_numbers, cover_image_url, cover_image_attribution, cover_image_source, recap_stories, opinion_left, opinion_center, opinion_right, opinion_headlines, opinion_topic, bias_report_text, bias_report_data, editor_note, audio_url, audio_duration_seconds, opinion_text, opinion_headline, opinion_lean, opinion_start_seconds, audio_voice, audio_voice_label, total_articles, total_clusters, created_at';
