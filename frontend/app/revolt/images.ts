/* ===========================================================================
   ...
   harvested from Wikipedia. Used as the hero for cards + detail stages when a
   revolution has no explicit heroImage. Keeping them in one file means images
   apply to both the mock and the DB-backed render without a re-load.
   Attribution is a light credit; the deep-dive always links to fuller sources.
   =========================================================================== */
...
export const REVOLT_HERO_IMAGES: Record<string, RevoltHeroImage> = {
  'french-revolution': { url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/57/Anonymous_-_Prise_de_la_Bastille.jpg/2560px-Anonymous_-_Prise_de_la_Bastille.jpg', attribution: 'Storming of the Bastille, anonymous, via Wikimedia Commons' },
  ...
  'springtime-of-nations-1848': { url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/cd/Horace_Vernet-Barricade_rue_Soufflot.jpg/2560px-Horace_Vernet-Barricade_rue_Soufflot.jpg', attribution: 'Barricade, rue Soufflot, Horace Vernet, via Wikimedia Commons' },
  ...
  'mexican-revolution': { url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/6e/Decena_tr%C3%A1gica.JPG/2560px-Decena_tr%C3%A1gica.JPG', attribution: 'Mexican Revolution, via Wikimedia Commons' },
  ...
  'algerian-revolution': { url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/0f/National_Liberation_Army_Soldiers_%287%29.jpg/2560px-National_Liberation_Army_Soldiers_%287%29.jpg', attribution: 'FLN soldiers, via Wikimedia Commons' },
  ...
  'iran-woman-life-freedom': { url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b9/Amir_Kabir_University_uprising_September_2022_%283%29.jpg/2560px-Amir_Kabir_University_uprising_September_2022_%283%29.jpg', attribution: 'Amir Kabir University, September 2022, via Wikimedia Commons' },
  ...
  'bangladesh-july-revolution': { url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/cc/7.Bangladesh_quota_reform_movement_2024.jpg/2560px-7.Bangladesh_quota_reform_movement_2024.jpg', attribution: 'Bangladesh, 2024, via Wikimedia Commons' },
  ...
  'georgia-eu-protests': { url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b7/Tbilisi_-_election_protests_28_October_2024.jpg/2560px-Tbilisi_-_election_protests_28_October_2024.jpg', attribution: 'Tbilisi, October 2024, via Wikimedia Commons' },
  'belarus-2020': { url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/54/Protest_actions_in_Minsk_%28Belarus%29_near_Stella%2C_August_16.jpg/2560px-Protest_actions_in_Minsk_%28Belarus%29_near_Stella%2C_August_16.jpg', attribution: 'Minsk, August 2020, via Wikimedia Commons' },
  ...
  'hong-kong': { url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/fb/Hong_Kong_anti-extradition_bill_protest_%2848108527758%29.jpg/2560px-Hong_Kong_anti-extradition_bill_protest_%2848108527758%29.jpg', attribution: 'Hong Kong, 2019, via Wikimedia Commons' },
  ...
  'thailand': { url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/bf/Protest_in_2020_Democracy_Monument_%28I%29.jpg/2560px-Protest_in_2020_Democracy_Monument_%28I%29.jpg', attribution: 'Bangkok, 2020, via Wikimedia Commons' },
};
