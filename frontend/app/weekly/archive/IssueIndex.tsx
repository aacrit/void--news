  ...
  return (
    <div className="wk-page">
      <header className="wk-topbar">
        {/* Same nameplate as every other weekly page: VOID NEWS | Weekly. The
            three-zone bar this replaced put a VOID WEEKLY lockup in the middle
            and a way back to it on the left; Weekly is a section of Void News,
            so it does not get the product lockup, and the nameplate is itself
            the way back. */}
        <SectionNameplate
          section="Weekly"
          href="/weekly"
